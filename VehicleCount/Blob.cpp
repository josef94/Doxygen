/*! \file Blob.cpp
    \brief The class used to handle all Blob operations.
	
	This class is responsible for all blob operations for the post processing. This involves the feature vector generation and processing of every vehicle driver.
*/
#include "Blob.h"

    //! A constructor.
    /*!
      A constructor which is necessary to generate a new blob.
	  \param _contour input contour as a vector of points.
...
Blob::Blob(vector<Point> _contour) {
 ...
 //! A function to predict the next position of a blob.
